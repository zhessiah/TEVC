...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.perturb_state = False
        self.attack_budget = 0.2
    ...
    def perturb_on(self):
        self.perturb_state = True
        
    def perturb_off(self):
        self.perturb_state = False
    ...
    def get_obs_agent(self, agent_id):
        ...
        if self.perturb_state:
            scale = np.random.uniform(-self.attack_budget, self.attack_budget, agent_obs.shape)
            agent_obs = agent_obs + scale
    ...
    def get_state(self):
        ...
        if self.perturb_state:
            scale = np.random.uniform(-self.attack_budget, self.attack_budget, state.shape)
            state = state + scale
